...
use super::{Cpu, State, CpuState, status_flags::StatusFlags, InterruptState, interrupts::Interrupt};
...
impl Opcode {
    pub(super) fn execute(&self, cpu: &mut Cpu, device: &Device, operand: Option<u8>, address: Option<u16>) -> State {
